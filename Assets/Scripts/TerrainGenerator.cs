...
public class TerrainGenerator : MonoBehaviour
{
    ...
    void DrawSquareLine(Bounds mapBounds)
    {
        float y = 2f; //arbitrary position to make the line visible on terrain
        lr.transform.position = mapBounds.center; //set the line renderer pos to the center of the map
        //define all vector3 for each point of the line 
